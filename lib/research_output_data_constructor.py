...
def students_line_list_constructor(worksheet):
    ...
    header_row1 = [''] * 10 + ["round_1"] + [''] * 43 + ["round_2"] + [''] * 43 + ["round_3"] + [''] * 43
    roundstring1 = ['google_result_rating'] + [''] * 19 + ['selections_per_category'] + [''] * 9 + [''] +\
                   ['average_google_category_rank'] + [''] * 12
    header_row2 = [''] * 4 + ["jdistances_vs_self_in_3_rounds"] + [''] * 2 +\
                  ["selection_jdistances_vs_self_in_3_rounds"] +[''] * 2 + roundstring1 * 3
    ...
    header_row3 = ["student_id"] + ["student_last_name"] + ["student_name"] + ["student_notes"] +\
                  (['rounds_1&2'] + ['rounds_1&3'] + ['rounds_2&3']) * 2 + roundstring2 * 3
    ...
    for student in students:
        ...
        jdistances = student['selection_jdistances']
        current_row += [str(jdistances[0]['(1,2)'])] + [str(jdistances[1]['(1,3)'])] + [str(jdistances[2]['(2,3)'])]
